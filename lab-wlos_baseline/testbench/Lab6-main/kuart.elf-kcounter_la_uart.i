# 0 "kcounter_la_uart.c"
# 1 "/home/ubuntu/Downloads/SoC/course-lab_6-2022.1/lab-wlos_baseline/testbench/Lab6-main//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "kcounter_la_uart.c"
# 19 "kcounter_la_uart.c"
# 1 "../../firmware/defs.h" 1
# 21 "../../firmware/defs.h"
...
# 20 "kcounter_la_uart.c" 2
# 1 "../../firmware/user_uart.h" 1
# 21 "kcounter_la_uart.c" 2
# 1 "../../firmware/stub.c" 1
# 18 "../../firmware/stub.c"
void putchar(char c)
{
...
extern int* matmul();
extern int* qsort();
# 46 "kcounter_la_uart.c"
void main()
{
# 99 "kcounter_la_uart.c"
 int j;
 ...
 int* tmp_f = fir();
 (*(volatile uint32_t*)0x2600000c) = *tmp_f << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+9) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_f+10) << 16;
 ...
 int *tmp_m = matmul();
 (*(volatile uint32_t*)0x2600000c) = *tmp_m << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_m+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_m+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_m+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_m+9) << 16;
 ...
 int* tmp_q = qsort();
 (*(volatile uint32_t*)0x2600000c) = *tmp_q << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+1) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+2) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+3) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+4) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+5) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+6) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+7) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+8) << 16;
 (*(volatile uint32_t*)0x2600000c) = *(tmp_q+9) << 16;
