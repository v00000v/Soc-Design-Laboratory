...
HD_PWD='/home/ubuntu/Downloads/SoC/course-lab_6-2022.1/lab-wlos_baseline/vivado/vvd_caravel_fpga/vvd_caravel_fpga.runs/design_1_axi_uartlite_0_0_synth_1'
cd "$HD_PWD"
